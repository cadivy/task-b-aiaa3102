...
裁决过程见 `docs/adjudication_protocol.md`。高置信度 label-error 和 ambiguous 案例必须双人独立复核；意见不一致时由第三人仲裁。
...
3. **Training label overlay**：只对双人确认的训练样本使用独立 overlay，不修改源标签。
...
| 三人判断标准不一致 | memo 无法合并 | 统一裁决表和第三人仲裁 |
